<template>
  <div class="place-slider">
    <div class="place-slider-container block-wrapper">
...
export default {
  ...
  methods: {
    initSwiper() { 
      this.swiperAbout = new Swiper(".place-slider-container", {
        slidesPerView: 1,
        speed: 1200,
        parallax: true,
        loop: true,
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      animateJS('scaleFullImage', document.querySelector(".place-slider-container .swiper-slide[data-swiper-slide-index='0']"));
    });
  }
};
</script>

...
export const actions = {
  async getData({commit}) {
    ...
    await this.$axios.$get(`${this.$axios.defaults.baseURL}/privacy-policy?populate[Meta_tags_privacy_policy][populate]=*&populate[Main_privacy][populate]=Content_privacy_policy,Form_privacy.Photo_cover_background,Form_input&locale=${this.locale}`)
      .then((res) => {

...
export const actions = {
  async getData({commit}) {
    ...
    await this.$axios.$get(`${this.$axios.defaults.baseURL}/all-accommodation?populate[Meta_tags_accommodation][populate]=*&populate[Main_all_accommodations][populate]=*&populate[Additional_block][populate]=*&locale=${this.locale}`)
      .then((res) => {
